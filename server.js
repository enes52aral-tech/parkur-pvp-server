  ...
  ws.on('message', (raw) => {
    ...
    switch (msg.type) {
      ...
      case 'create_room': {
        ...
        const room = {
          players: [ws],
          playerData: [{ weapon: msg.weapon || 'fist', slot2: msg.slot2 || null, skin: msg.skin || 'default', name: msg.name || 'OYUNCU 1' }],
          arenaIdx: msg.arenaIdx || 0,
      ...
      case 'join_room': {
        ...
        room.playerData.push({ weapon: msg.weapon || 'fist', slot2: msg.slot2 || null, skin: msg.skin || 'default', name: msg.name || 'OYUNCU 2' });
        ...
        room.started = true;
        const startData = { type: 'game_start', playerData: room.playerData, round: 1, maxRounds: room.maxRounds, arenaIdx: room.arenaIdx || 0 };
      ...
      case 'rematch': {
        ...
        if (room.players.every(p => p.wantsRematch)) {
          ...
          room.players.forEach(p => { p.wantsRematch = false; send(p, { type: 'game_start', playerData: room.playerData, round: 1, maxRounds: room.maxRounds, arenaIdx: room.arenaIdx || 0 }); });
        } else {
